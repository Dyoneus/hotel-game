-- Studio helper: create the Grand Studio owned-room layout template.
--
-- Run this manually in Roblox Studio Command Bar or from a temporary Script.
-- The helper creates ReplicatedStorage.RoomTemplates.RoomLayout_Free_104_A.
--
-- Grand Studio is a simple rectangular 13x8 free room with 104 walkable tiles.
-- It intentionally has no stairs, holes, hidden areas, multi-level structures,
-- or default furniture.

local ReplicatedStorage = game:GetService("ReplicatedStorage")

local TOOL_PREFIX = "[CreateRoomLayout_Free_104_A]"
...
local LAYOUT_ID = "Free_104_A"
local TEMPLATE_NAME = "RoomLayout_Free_104_A"
local DISPLAY_NAME = "Grand Studio"
...
local COLORS = {
	Floor = Color3.fromRGB(189, 184, 171),
	FloorGrid = Color3.fromRGB(165, 160, 146),
	Wall = Color3.fromRGB(219, 212, 194),
	WallTrim = Color3.fromRGB(135, 126, 99),
	DarkTrim = Color3.fromRGB(80, 71, 55),
	Entrance = Color3.fromRGB(129, 143, 137),
	EntranceEdge = Color3.fromRGB(77, 95, 89),
}
