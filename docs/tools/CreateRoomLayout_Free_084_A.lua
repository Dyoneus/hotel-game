-- Studio helper: create the Long Studio owned-room layout template.
--
-- Run this manually in Roblox Studio Command Bar or from a temporary Script.
-- The helper creates ReplicatedStorage.RoomTemplates.RoomLayout_Free_084_A.
--
-- Long Studio is a simple rectangular 7x12 free room with 84 walkable tiles.
-- It intentionally has no stairs, holes, hidden areas, multi-level structures,
-- or default furniture.

local ReplicatedStorage = game:GetService("ReplicatedStorage")

local TOOL_PREFIX = "[CreateRoomLayout_Free_084_A]"
...
local LAYOUT_ID = "Free_084_A"
local TEMPLATE_NAME = "RoomLayout_Free_084_A"
local DISPLAY_NAME = "Long Studio"
...
local COLORS = {
	Floor = Color3.fromRGB(187, 183, 170),
	FloorGrid = Color3.fromRGB(163, 158, 144),
	Wall = Color3.fromRGB(218, 211, 193),
	WallTrim = Color3.fromRGB(133, 125, 98),
	DarkTrim = Color3.fromRGB(78, 70, 54),
	Entrance = Color3.fromRGB(126, 142, 138),
	EntranceEdge = Color3.fromRGB(75, 94, 90),
}
