-- Studio helper: create the Grand Hall owned-room layout template.
--
-- Run this manually in Roblox Studio Command Bar or from a temporary Script.
-- The helper creates ReplicatedStorage.RoomTemplates.RoomLayout_Free_320_A.
--
-- Grand Hall is a simple rectangular 20x16 free room with 320 walkable tiles.
-- It intentionally has no stairs, holes, hidden areas, multi-level structures,
-- or default furniture.

local ReplicatedStorage = game:GetService("ReplicatedStorage")

local TOOL_PREFIX = "[CreateRoomLayout_Free_320_A]"
local REPLACE_EXISTING = true

local LAYOUT_ID = "Free_320_A"
local TEMPLATE_NAME = "RoomLayout_Free_320_A"
local DISPLAY_NAME = "Grand Hall"
