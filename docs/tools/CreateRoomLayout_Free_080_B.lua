-- Studio helper: create the Tall Studio owned-room layout template.
--
-- Run this manually in Roblox Studio Command Bar or from a temporary Script.
-- The helper creates ReplicatedStorage.RoomTemplates.RoomLayout_Free_080_B.
--
-- Tall Studio is a simple rectangular 8x10 free room with 80 walkable tiles.
...
local DISPLAY_NAME = "Tall Studio"
...
local COLORS = {
	Floor = Color3.fromRGB(188, 184, 172),
	FloorGrid = Color3.fromRGB(166, 162, 150),
	Wall = Color3.fromRGB(219, 213, 196),
	WallTrim = Color3.fromRGB(137, 128, 101),
	DarkTrim = Color3.fromRGB(82, 74, 56),
	Entrance = Color3.fromRGB(128, 141, 150),
	EntranceEdge = Color3.fromRGB(78, 94, 105),
}
...
print(string.format(
	"%s LayoutId=%s TemplateName=%s DisplayName=%s TileCount=%d Grid=%dx%d TileSize=%d WalkableFloorSize=(%.1f, %.1f, %.1f)",
	TOOL_PREFIX,
	LAYOUT_ID,
	TEMPLATE_NAME,
	DISPLAY_NAME,
