-- Studio helper: create the Wide Gallery owned-room layout template.
--
-- Run this manually in Roblox Studio Command Bar or from a temporary Script.
-- The helper creates ReplicatedStorage.RoomTemplates.RoomLayout_Free_384_A.
--
-- Wide Gallery is a simple rectangular 24x16 free room with 384 walkable tiles.
-- It intentionally has no stairs, holes, hidden areas, multi-level structures,
-- or default furniture.

local ReplicatedStorage = game:GetService("ReplicatedStorage")

local TOOL_PREFIX = "[CreateRoomLayout_Free_384_A]"
local REPLACE_EXISTING = true

local LAYOUT_ID = "Free_384_A"
local TEMPLATE_NAME = "RoomLayout_Free_384_A"
local DISPLAY_NAME = "Wide Gallery"
